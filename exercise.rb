...
mycohort = Cohort.new(Date.new(2018, 7, 2))
puts mycohort.coffee_code_days
puts mycohort.last_day
puts mycohort.class_days
puts mycohort.coffee_code_day?(Date.new(2018, 7, 21))
puts mycohort.coffee_code_week?(Date.new(2018, 8, 1))
